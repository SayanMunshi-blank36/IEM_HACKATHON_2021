...
loginBtn.addEventListener("click",(e)=>{
    ...
    let atPosition = document.myForm_seller.userEmail_seller.value.indexOf("@");
    let dotPosition = document.myForm_seller.userEmail_seller.value.indexOf(".");

    if(email.value.length === 0 || atPosition<1 || dotPosition < atPosition+2|| dotPosition+2>=document.myForm_seller.userEmail_seller.value.length){
