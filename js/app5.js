...
loginBtn.addEventListener("click",(e)=>{
    ...
    let atPosition = document.myForm_signin_seller.userEmail_signin_seller.value.indexOf("@");
    let dotPosition = document.myForm_signin_seller.userEmail_signin_seller.value.indexOf(".");

    if(email.value.length === 0 || atPosition<1 || dotPosition < atPosition+2|| dotPosition+2>=document.myForm_signin_seller.userEmail_signin_seller.value.length){
